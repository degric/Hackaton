...
public class HeaderFooterPageEventConstanciaInduccion extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private ConstanciaInduccionDTO listado;

    public HeaderFooterPageEventConstanciaInduccion(String headerText, Image headerImage, ConstanciaInduccionDTO datos) {
