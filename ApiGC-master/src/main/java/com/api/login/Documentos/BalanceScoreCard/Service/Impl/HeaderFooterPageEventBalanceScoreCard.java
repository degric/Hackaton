...
public class HeaderFooterPageEventBalanceScoreCard extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private BalanceScoreCardDTO listado;

    public HeaderFooterPageEventBalanceScoreCard(String headerText, Image headerImage, BalanceScoreCardDTO datos) {
