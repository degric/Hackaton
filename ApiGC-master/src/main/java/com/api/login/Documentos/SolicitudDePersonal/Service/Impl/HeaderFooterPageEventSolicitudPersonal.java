...
public class HeaderFooterPageEventSolicitudPersonal extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private SolicitudPersonalDTO listado;

    public HeaderFooterPageEventSolicitudPersonal(String headerText, Image headerImage, SolicitudPersonalDTO datos) {
