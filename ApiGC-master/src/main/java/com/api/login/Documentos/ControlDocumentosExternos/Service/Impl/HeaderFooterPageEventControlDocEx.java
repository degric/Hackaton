...
public class HeaderFooterPageEventControlDocEx extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private ControlDocumentosExternos listado;

    public HeaderFooterPageEventControlDocEx(String headerText, Image headerImage,ControlDocumentosExternos datos) {
