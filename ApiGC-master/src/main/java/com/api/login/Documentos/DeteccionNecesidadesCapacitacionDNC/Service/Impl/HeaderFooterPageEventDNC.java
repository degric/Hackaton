...
public class HeaderFooterPageEventDNC extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private DetecionNeCaDNCDTO listado;

    public HeaderFooterPageEventDNC(String headerText, Image headerImage, DetecionNeCaDNCDTO datos) {
