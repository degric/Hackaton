...
public class HeaderFooterPageEventListaDeVerificacion extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private ListaVerificacionDTO listado;

    public HeaderFooterPageEventListaDeVerificacion(String headerText, Image headerImage, ListaVerificacionDTO datos) {
