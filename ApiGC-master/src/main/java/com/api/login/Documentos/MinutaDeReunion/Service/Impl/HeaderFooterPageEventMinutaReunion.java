...
public class HeaderFooterPageEventMinutaReunion extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private MinutaReunionDTO listado;

    public HeaderFooterPageEventMinutaReunion(String headerText, Image headerImage, MinutaReunionDTO datos) {
