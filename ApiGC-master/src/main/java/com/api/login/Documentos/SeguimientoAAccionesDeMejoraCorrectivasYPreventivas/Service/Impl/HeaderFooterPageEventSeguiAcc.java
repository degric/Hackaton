...
public class HeaderFooterPageEventSeguiAcc extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private SeguiAccioMejoCorrePrevDTO listado;

    public HeaderFooterPageEventSeguiAcc(String headerText, Image headerImage, SeguiAccioMejoCorrePrevDTO datos) {
