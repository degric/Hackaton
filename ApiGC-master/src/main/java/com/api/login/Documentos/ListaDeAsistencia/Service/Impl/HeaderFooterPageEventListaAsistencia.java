...
public class HeaderFooterPageEventListaAsistencia extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private ListaAsistenciaDTO listado;

    public HeaderFooterPageEventListaAsistencia(String headerText, Image headerImage, ListaAsistenciaDTO datos) {
