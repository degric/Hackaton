...
public class HeaderFooterPageEventMejoraContinua extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private MejoraContinuaDTO listado;

    public HeaderFooterPageEventMejoraContinua(String headerText, Image headerImage, MejoraContinuaDTO datos) {
