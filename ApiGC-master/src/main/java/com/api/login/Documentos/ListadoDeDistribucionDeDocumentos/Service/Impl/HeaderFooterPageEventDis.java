...
public class HeaderFooterPageEventDis extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private ListadoDistribucionDocumentosDTO listado;

    public HeaderFooterPageEventDis(String headerText, Image headerImage, ListadoDistribucionDocumentosDTO datos) {
