...
public class HeaderFooterPageEventProgramaAnualCapacitacion extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private ProAnualCapacitacionDTO listado;

    public HeaderFooterPageEventProgramaAnualCapacitacion(String headerText, Image headerImage, ProAnualCapacitacionDTO datos) {
