...
public class HeaderFooterPageEventPlanAuditoria extends PdfPageEventHelper {

    private String headerText;
    private Image headerImage;
    private PlanAuditoriaDTO listado;

    public HeaderFooterPageEventPlanAuditoria(String headerText, Image headerImage, PlanAuditoriaDTO datos) {
